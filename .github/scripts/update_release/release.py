...
def create_release_task(GITHUB_REPO: str, OWNER: str, TAG_NAME: str, TARGET_COMMITISH: str, NAME_RELEASE: str, BODY: str, DRAFT: str, PRERELEASE: str, GENERATE_NOTES: str ):
    ...
    data = {"owner": OWNER,"name": GITHUB_REPO, "tag_name":TAG_NAME,"target_commitish":TARGET_COMMITISH,"name":NAME_RELEASE,"body":BODY,"draft":DRAFT,"prerelease":PRERELEASE,"generate_release_notes":GENERATE_NOTES}
